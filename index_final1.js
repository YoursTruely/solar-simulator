...
// console.log(Data);
//////// UI /////////////////////////
let RotSlider = document.getElementById("myRangeRot");
let RevSlider = document.getElementById("myRangeRev");
...
let tick = function(){
    ...
    planets.forEach(planet => {
        let d_theta =  parseInt(RotSlider.value)*planet.rot_speed*elapsed;
        let d_phi =  parseInt(RevSlider.value)*planet.rev_speed*elapsed;
