...
class Planet{
  constructor(planet_data){
    ...
    Model(theta,phi){
      ...
      modelMatrix.setRotate(rev_phi,0,1,0); //change 1
...
let tick = function(){
    ...
    planets.forEach(planet => {
        let d_theta =  parseInt(slider.value)*planet.rot_speed*elapsed;
